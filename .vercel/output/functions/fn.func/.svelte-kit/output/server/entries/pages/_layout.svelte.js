...
const __uno = "";
const style$1 = "";
const prebuildIconifyIcons = "";
const style = "";
const AjaxBar_svelte_svelte_type_style_lang = "";
const css$f = {
...
const ToggleDark_svelte_svelte_type_style_lang = "";
const css$c = {
...
const css = {
  code: "footer.svelte-1dvkwe1{z-index:9999 !important}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(GlobalLayout, "PageLayout").$$render($$result, { fm }, {}, {
    default: () => {
      return `<h2 data-svelte-h="svelte-1bs0j5i">Where is this?</h2> ${slots.default ? slots.default({}) : ``} <footer class="flex items-center pt-2 text-center content-center justify-around w-full bg-orange-600 svelte-1dvkwe1" data-svelte-h="svelte-1shiytm"><img class="ml-2 mb-2 h-10 md:ml-26" src="/ag.png" alt="Australian Government logo" width="auto" height="40"> <p class="text-[0.6rem] md:text-sm">This is a Bushfire Community Recovery &amp; Resilience Fund project through the joint
		Commonwealth/State Disaster Recovery Funding Arrangements</p> <img class="mr-2 mb-2 h-10 md:mr-26" src="/nswg.jpg" alt="NSW Government logo"></footer>`;
    }
  })}`;
});
export {
