...
const themeOptions = { "navbar": [{ "title": "For Developers", "items": [{ "title": "Site Development", "to": "/development-site/introduction/" }, { "title": "Database Development", "to": "/development-db/introduction/" }, { "title": "Documentation Development", "to": "/development-docs/introduction/" }] }, { "title": "FAQ", "to": "/faqs/faq" }, { "title": "SOC", "external": true, "to": "https://soc-dev.vercel.app/" }], "sidebar": { "/development-site/": [{ "title": "Site Development", "collapsible": true, "collapsed": false, "items": [{ "title": "Introduction", "to": "/development-site/introduction/" }] }], "/development-db/": [{ "title": "Database Development", "collapsible": true, "collapsed": false, "items": [{ "title": "Introduction", "to": "/development-db/introduction/" }] }], "/development-docs/": [{ "title": "Documentation Development", "collapsible": true, "collapsed": false, "items": [{ "title": "Introduction", "to": "/development-site/introduction/" }] }], "/faqs/": [{ "title": "Frequently Asked", "to": "/faqs/faq/" }] }, "editLink": "https://github.com/BCYCAData/socdocs-technicalguides/edit/main/src/routes/:route", "github": "https://github.com/BCYCAData/socdocs-technicalguides", "logo": "/SOCLogo_quarter.png", "preBuildIconifyIcons": { "carbon": ["user"], "grommet-icons": ["system"], "tabler": ["stack-2"] }, "themeColor": { "light": "", "dark": "", "primary": "", "hover": "", "gradient": { "start": "#ea580c", "end": "#fed7aa" } } };
